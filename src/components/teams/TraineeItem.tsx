...
interface TraineeItemProps {
  ...
  onTogglePaid: (e: React.MouseEvent, id: string, isPaid: boolean) => void
  onSelect: (trainee: Trainee) => void
}

export const TraineeItem = memo(function TraineeItem({
  trainee,
  locale,
  isAdmin,
  isLoading,
    ...
    >
      <div className="flex items-center gap-4">
        <div className="relative">
          ...
          {isAdmin && (
             <button
               onClick={(e) => onTogglePaid(e, trainee.id, !!isPaid)}
      ...
      {isAdmin && (
        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
           <button
             disabled={isLoading}
             onClick={(e) => onDelete(e, trainee.id, name)}
